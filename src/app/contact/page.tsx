    ...
    <Container className="py-24">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-primary mb-4">İletişim Bilgileri</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex items-start">
              ...
              <div>
                ...
                <a
                  ...
                  className="mt-2 text-neutral hover:text-accent transition-colors cursor-pointer block"
                >
                  Feyzullah Mahallesi<br />
                  Serap Caddesi<br />
                  No: 9, 34843 Maltepe/İstanbul
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="mt-2 text-neutral">
                  <a href="mailto:info@moodcoffee.tr" className="hover:text-accent transition-colors">
                    info@moodcoffee.tr
                  </a>
                </p>
              </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="mt-2 text-neutral">
                  <a href="tel:+905415945834" className="hover:text-accent transition-colors">
                    +90 (541) 594 58 34 <br />
                  </a>
                  <a href="tel:+905316922045" className="hover:text-accent transition-colors">
                    +90 (531) 692 20 45
                  </a>
                </p>
              </div>
            ...
            <div className="flex items-start md:col-span-2">
              ...
              <div>
                ...
                <p className="mt-2 text-neutral">
                  Pazartesi - Cumartesi: 08:00 - 02:00<br />
                  Pazar: 09:00 - 02:00<br />
                </p>
              </div>
            </div>
          </div>
